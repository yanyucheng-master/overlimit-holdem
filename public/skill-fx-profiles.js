(function initOverlimitSkillFxProfiles(root, factory) {
  ...
  const FX_TIERS = Object.freeze({
    FX1: Object.freeze({ min: 350, max: 550, defaultMs: 460 }),
    FX2: Object.freeze({ min: 500, max: 750, defaultMs: 650 }),
    FX3: Object.freeze({ min: 650, max: 1000, defaultMs: 860 }),
    FX4: Object.freeze({ min: 850, max: 1300, defaultMs: 1100 }),
  ...
  const SKILL_FX_PROFILES = Object.freeze({
    ...
    INTIMIDATION: profile({
      ...
      tier: "FX4", family: "intimidation", anchor: "board", impact: "board", accent: "#ff5f76",
    ...
    DESPERATION: profile({
      ...
      tier: "FX2", family: "desperation", anchor: "caster", impact: "player", accent: "#ff456b",
    ...
    BLOOD_BATTLE: profile({
      ...
      tier: "FX3", family: "blood", anchor: "pot", impact: "chip", accent: "#ff2d5d",
    ...
    DEFENSE: profile({
      ...
      tier: "FX2", family: "defense", anchor: "caster", impact: "player", visibility: VISIBILITY.SECRET,
    ...
    PERCEPTION: profile({
      ...
      tier: "FX2", family: "perception", anchor: "target", impact: "card", visibility: VISIBILITY.SECRET,
      accent: "#63f4de", secondary: "#4aaeff", glyph: "◉", sound: "whisper",
      resultLabel: "SIGNAL ACQUIRED",
    }),
    INTEL_ONE: profile({
      id: "INTEL_ONE", name: "情报", english: "INTEL",
      tier: "FX3", family: "intel", anchor: "target", impact: "card", visibility: VISIBILITY.SECRET,
      accent: "#3fe5ff", secondary: "#e6faff", glyph: "⌖", sound: "scan",
      resultLabel: "TARGET READ",
    }),
    TOP_SECRET: profile({
      id: "TOP_SECRET", name: "绝密", english: "TOP SECRET",
      tier: "FX3", family: "top-secret", anchor: "caster", impact: "card", visibility: VISIBILITY.SECRET,
    ...
    COUNTER: profile({
      ...
      tier: "FX3", family: "counter", anchor: "target", impact: "interrupt", visibility: VISIBILITY.SECRET,
    ...
    FAIRNESS: profile({
      ...
      tier: "FX4", family: "fairness", anchor: "board", impact: "board", accent: "#ffe7a0",
    ...
    DEAD_END: profile({
      ...
      tier: "FX4", family: "dead-end", anchor: "board", impact: "board", accent: "#ff3c61",
    ...
    CLAIRVOYANCE: profile({
      ...
      tier: "FX2", family: "clairvoyance", anchor: "opponent", impact: "hud", visibility: VISIBILITY.SECRET,
    ...
    NULLIFICATION: profile({
      ...
      tier: "FX3", family: "nullification", anchor: "target", impact: "card", visibility: VISIBILITY.SECRET,
    ...
    DESTINY: profile({
      ...
      tier: "FX4", family: "destiny", anchor: "river", impact: "card", visibility: VISIBILITY.SECRET,
    ...
    LOAN: profile({
      ...
      tier: "FX2", family: "loan", anchor: "players", impact: "chip", visibility: VISIBILITY.MIXED,
    ...
    RETREAT: profile({
      ...
      tier: "FX3", family: "retreat", anchor: "pot", impact: "chip", visibility: VISIBILITY.SECRET,
    ...
    RESTART: profile({
      ...
      tier: "FX3", family: "restart", anchor: "cards", impact: "card", visibility: VISIBILITY.SECRET,
    ...
    DISGUISE: profile({
      ...
      tier: "FX3", family: "disguise", anchor: "board", impact: "hud", accent: "#9e74ff",
  ...
  const PROTOCOL_SHOWDOWN_PROFILE = profile({
    ...
    tier: "FX3", family: "protocol", anchor: "settlement", impact: "card", visibility: VISIBILITY.RESULT,
