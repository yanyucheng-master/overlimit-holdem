  ...
  skills: [
    ...
    },
    {
      ...
      meta: [
        ...
        "Energy 3",
        "Passive · Secret",
        "Default ON · one disarm per hand"
      ],
      keywords: "底牌保护 读取 推断 交换 零化 情报 千术 感知",
      content: "<p>Passive / Secret / information defense. Load 3, cost 3. Each hand starts ON (ARMED). You may turn it off once on either player's turn; OFF is locked for that hand. Disarming costs no Energy, takes no poker action and is not a skill event. Before an enemy effect reads, infers, swaps, nullifies or operates on your private Hole Cards, an armed guard with at least 3 Energy and permission to create a new skill event immediately pays 3 and blocks it. Protection then stays ON (ACTIVE_LOCKED) for the hand with no further charges. Insufficient Energy lets the effect through but leaves the guard armed; it can trigger after Energy recovers or still be turned off. Covers Perception facts, Intel Hole Card mode, Cheat opponent Hole Card mode and Nullification Hole Card mode, not Community Cards, future cards or skill metadata queries such as Clairvoyance. Attackers pay normally and receive a generic failure; Recycle still applies. The block does not disclose Top Secret or its private state. Successful protection is a real skill event and breaks Deep Breath, but does not trigger Alert or Counter. Disarming does not break Deep Breath. Fairness clears protection and prevents reactivation that hand. Dead End prevents a new activation but preserves existing protection. Reconnect preserves the state; the next hand resets it ON. Public hand audits omit this defense event; Clairvoyance retains its existing authorized access to skills already used.</p>"
    },
    {
      id: "skill-counter",
      number: "10",
