(function initIncomingI18n(root) {
  ...
  const EXACT = Object.freeze({
    ...
    "未能获取目标底牌信息。": "private.intelBlocked",
    "目标私人底牌无法被操作。": "private.cheatBlocked",
    "未能锁定该私人底牌。": "private.nullifyBlocked",
    "绝密已生效。": "secretGuard.triggered",
    "本次未获得有效的私人信息。": "secretGuard.noPrivateInfo",
